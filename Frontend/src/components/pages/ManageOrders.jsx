              ...
              {order.items.map((item, i) => (
                <div key={i} className="flex items-center gap-3 pb-3 border-b border-[#232F49] last:border-0 last:pb-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-[#EDF1F7] truncate">{item.productId?.name || "Product"}</p>
                  ...
                  {filtered.length > 0 ? (
                    filtered.map((order) => (
                      <tr key={order._id} className="hover:bg-[#121A2E]/50 transition-colors group">
                        ...
                        <td className="px-5 py-4">
                          <p className="text-sm font-semibold text-[#EDF1F7] whitespace-nowrap">{order.userId?.name || "Unknown"}</p>
                          <p className="text-xs text-[#8592AC] truncate max-w-[120px]">{order.userId?.email || ""}</p>
                        </td>
