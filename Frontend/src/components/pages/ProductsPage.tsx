...
const SortDropdown: React.FC<{ value: string; onChange: (value: string) => void }> = ({ value, onChange }) => {
  ...
  return (
    <div className="relative">
      <button
        onClick={() => setOpen(o => !o)}
        className="flex items-center gap-2 px-3.5 py-2 bg-[#121A2E] border border-[#232F49] rounded-lg text-xs font-mono uppercase tracking-wide text-[#8592AC] hover:text-[#EDF1F7] transition-colors"
      >
        {current.label}
          ...
          {loading ? (
            ...
            <div className="relative flex flex-col items-center justify-center py-24 gap-4 bg-[#121A2E] rounded-xl border border-dashed border-rose-400/30">
              ...
              <div className="text-center">
                ...
                <p className="text-[#8592AC] font-mono text-xs">Couldn't load products. Please try again.</p>
              </div>
            </div>
