...
import { UserContext } from './context/UserContext.jsx'; // ✅ add this
...
/* ================= PRODUCT CARD ================= */
const ProductCard = ({ product, handleCartClick, isAdmin }) => (  // ✅ receive isAdmin
    ...
    <div className="p-3">
      ...
      <div className="flex items-center justify-between">
        ...
        {!isAdmin ? (
          ...
          className="px-2 py-1 cursor-pointer text-xs text-slate-300 bg-slate-700 rounded-lg">
            Manage
          </button>
        )}
      </div>
...
/* ================= PRODUCT SECTION ================= */
const ProductSection = React.memo(({ title, products, handleCartClick, isAdmin }) => {
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex gap-2">
          <button onClick={() => scroll('left')} disabled={!canScrollLeft}
            className="p-2 rounded-full text-white bg-slate-800 hover:bg-slate-700 disabled:opacity-40">
            <FiChevronLeft />
          </button>
...
const Homepage = () => {
  ...
  const isAdmin = user?.role === 'admin' // ✅ derive once
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <section id="products" className="max-w-7xl mx-auto px-4 py-12">
          <ProductSection
            ...
            isAdmin={isAdmin} // ✅ pass to each section
          />
          <ProductSection
        ...
        {/* ✅ Only show CartToast for non-admins */}
        {!isAdmin && <CartToast />}
      </div>
